...
function MGCSimulator() {
  ...
  return (
    <div>
      <h1 className="font-bold text-2xl bg-[#2daab8] text-white px-2 py-1">M/G/C Queuing Simulator</h1>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          handleSubmit();
